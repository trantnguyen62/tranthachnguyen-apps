      ...
      <main className="flex-1 pt-16">
        ...
        <section className="py-20 bg-foreground">
          <div className="mx-auto max-w-[1100px] px-4 sm:px-6 lg:px-8">
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 text-[var(--text-secondary)] mb-6">
        ...
        {/* Trusted By */}
        <section className="py-16 bg-[var(--surface-secondary)]/50">
          <div className="mx-auto max-w-[1100px] px-4 sm:px-6 lg:px-8">
          ...
          <div className="mx-auto max-w-[1100px] px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <motion.div
                ...
                whileInView={{ opacity: 1, x: 0 }}
                viewport={{ once: true }}
                className="p-8 rounded-lg bg-[var(--surface-secondary)]/50 border border-[var(--border-primary)]"
              >
                <Shield className="h-12 w-12 text-[var(--text-primary)] mb-4" />
              ...
              >
                <div className="grid grid-cols-2 gap-6">
                  {[
                    ...
                    <div
                      key={stat.label}
                      className="p-6 rounded-lg bg-[var(--surface-primary)] text-center"
                    >
