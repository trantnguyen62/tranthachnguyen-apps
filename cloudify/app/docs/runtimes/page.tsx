    ...
    <article className="prose prose-gray dark:prose-invert max-w-none">
      ...
      <div className="not-prose grid grid-cols-1 gap-4 my-8">
        {[
          ...
          <div key={runtime.name} className="flex items-start gap-4 p-4 rounded-lg bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800">
            <Check className="h-5 w-5 text-green-500 shrink-0 mt-1" />
            <div className="flex-1">
              <div className="flex items-center gap-2">
                <span className="font-semibold text-gray-900 dark:text-white">{runtime.name}</span>
              ...
              <p className="text-sm text-gray-500">{runtime.version} - {runtime.desc}</p>
            </div>
          </div>
        ))}
      </div>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-gray-200 dark:border-gray-800">
              ...
              <th className="text-left py-3 px-4 font-semibold text-gray-900 dark:text-white">Max Duration</th>
              <th className="text-left py-3 px-4 font-semibold text-gray-900 dark:text-white">Memory</th>
              <th className="text-left py-3 px-4 font-semibold text-gray-900 dark:text-white">Payload</th>
            </tr>
          </thead>
          <tbody>
            <tr className="border-b border-gray-200 dark:border-gray-800">
              <td className="py-3 px-4 text-gray-600 dark:text-gray-400">Hobby</td>
              <td className="py-3 px-4 text-gray-600 dark:text-gray-400">10 seconds</td>
              <td className="py-3 px-4 text-gray-600 dark:text-gray-400">1024 MB</td>
              <td className="py-3 px-4 text-gray-600 dark:text-gray-400">4.5 MB</td>
            </tr>
            <tr className="border-b border-gray-200 dark:border-gray-800">
              <td className="py-3 px-4 text-gray-600 dark:text-gray-400">Pro</td>
              <td className="py-3 px-4 text-gray-600 dark:text-gray-400">60 seconds</td>
              <td className="py-3 px-4 text-gray-600 dark:text-gray-400">3008 MB</td>
              <td className="py-3 px-4 text-gray-600 dark:text-gray-400">4.5 MB</td>
            </tr>
            <tr className="border-b border-gray-200 dark:border-gray-800">
              <td className="py-3 px-4 text-gray-600 dark:text-gray-400">Enterprise</td>
              <td className="py-3 px-4 text-gray-600 dark:text-gray-400">900 seconds</td>
              <td className="py-3 px-4 text-gray-600 dark:text-gray-400">3008 MB</td>
              <td className="py-3 px-4 text-gray-600 dark:text-gray-400">4.5 MB</td>
            </tr>
          </tbody>
