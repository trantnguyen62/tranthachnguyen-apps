                ...
                <nav className="space-y-1">
                  {quickLinks.map((link) => (
                    <a
                      key={link.label}
                      href={link.href}
                      className="flex items-center gap-2 px-3 py-2 text-sm text-[var(--text-secondary)] hover:text-[var(--text-primary)] hover:bg-secondary dark:text-[var(--text-secondary)] dark:hover:text-white dark:hover:bg-gray-800 rounded-lg"
                    >
          ...
          <main className="lg:col-span-3 space-y-12">
                  ...
                  >
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex items-center gap-2">
                        <code className="text-lg font-bold text-[var(--text-primary)] font-mono">
                          {cmd.command}
                        </code>
                      </div>
                      <Button
            ...
            <section className="p-6 bg-[var(--surface-secondary)] rounded-xl border border-blue-100 dark:border-blue-800">
              <div className="flex items-start gap-4">
                <Zap className="h-6 w-6 text-[var(--text-primary)] shrink-0" />
                <div>
