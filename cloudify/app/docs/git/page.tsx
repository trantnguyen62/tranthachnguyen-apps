  ...
  return (
    <article className="prose prose-gray dark:prose-invert max-w-none">
      ...
      <div className="not-prose grid grid-cols-1 md:grid-cols-3 gap-4 my-8">
        <div className="p-6 rounded-xl border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900 text-center">
        ...
        <div className="p-6 rounded-xl border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900 text-center">
          <svg className="h-12 w-12 mx-auto mb-4 text-blue-500" viewBox="0 0 24 24" fill="currentColor">
