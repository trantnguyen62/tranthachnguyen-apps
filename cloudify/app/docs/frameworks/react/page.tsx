  ...
  return (
    <article className="prose prose-gray dark:prose-invert max-w-none">
      <div className="not-prose flex items-center gap-4 mb-8">
        <div className="w-16 h-16 rounded-2xl bg-[#61DAFB] flex items-center justify-center">
        ...
        <div>
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white m-0">React on Cloudify</h1>
          <p className="text-gray-600 dark:text-gray-400 m-0 mt-1">Deploy React applications with zero configuration</p>
        </div>
      </div>
