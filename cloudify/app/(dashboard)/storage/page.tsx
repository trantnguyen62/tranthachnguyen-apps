          ...
          <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
            ...
            <DialogContent>
              ...
              <DialogFooter>
                ...
                <Button variant="primary" onClick={handleCreateStore} disabled={isCreating}>
                  {isCreating ? (
                    <>
        ...
        <TabsContent value="blob" className="mt-6">
          {filteredBlobStores.length === 0 ? (
            <div className="text-center py-12 bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800">
              ...
              <Button variant="primary" onClick={() => { setStoreType("blob"); setDialogOpen(true); }}>
                <Plus className="h-4 w-4" />
                Create Blob Store
              </Button>
            </div>
                ...
                >
                  ...
                  <div className="space-y-2 text-sm text-gray-500">
                    <div className="flex justify-between">
                      <span>Files</span>
                      <span className="text-gray-900 dark:text-white">{store.blobCount}</span>
                    </div>
                    <div className="flex justify-between">
                      <span>Size</span>
                      <span className="text-gray-900 dark:text-white">{formatSize(store.totalSize)}</span>
                    </div>
                    <div className="flex justify-between">
                      <span>Created</span>
        ...
        <TabsContent value="kv" className="mt-6">
          {filteredKVStores.length === 0 ? (
            <div className="text-center py-12 bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800">
              ...
              <Button variant="primary" onClick={() => { setStoreType("kv"); setDialogOpen(true); }}>
                <Plus className="h-4 w-4" />
                Create KV Store
              </Button>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
              {filteredKVStores.map((store, index) => (
                <motion.div
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ delay: index * 0.05 }}
                  className="p-5 bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 hover:border-purple-300 dark:hover:border-purple-700 transition-colors"
                >
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex items-center gap-3">
                  ...
                  <div className="space-y-2 text-sm text-gray-500">
                    <div className="flex justify-between">
                      <span>Keys</span>
                      <span className="text-gray-900 dark:text-white">{store._count?.entries || 0}</span>
                    </div>
                    <div className="flex justify-between">
                      <span>Created</span>
                      <span>{formatDate(store.createdAt)}</span>
