                ...
                {featuredPosts.map((post, index) => (
                  ...
                  >
                    <Link href={`/blog/${post.id}`}>
                      <div
                        className={cn(
                          "aspect-video rounded-2xl bg-gradient-to-br flex items-center justify-center mb-4",
                          post.gradient
                        )}
                      >
          ...
          <div className="mx-auto max-w-xl px-4 sm:px-6 lg:px-8 text-center">
            ...
            <form className="flex gap-3">
              <input
                ...
                className="flex-1 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 px-4 py-3 text-gray-900 dark:text-white placeholder:text-gray-400"
              />
