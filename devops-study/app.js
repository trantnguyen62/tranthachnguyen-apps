...
echo "Server setup complete!"`
        ...
        },
        {
            ...
            quiz: [
                ...
                { question: 'What does ELK stand for?', options: ['Elasticsearch, Logstash, Kibana', 'Elastic, Lambda, Kubernetes', 'Event, Log, Key', 'External Load Keeper'], correct: 0 },
                { question: 'What is an SLO?', options: ['Service Level Output', 'System Log Observer', 'Server Load Optimizer', 'Service Level Objective'], correct: 3 },
                { question: 'What does the RED method stand for?', options: ['Reliability, Errors, Downtime', 'Requests, Events, Data', 'Rate, Errors, Duration', 'Resources, Endpoints, DNS'], correct: 2 },
                ...
                { question: 'What does Alertmanager handle in the Prometheus stack?', options: ['Storing metrics', 'Scraping targets', 'Routing and deduplication of alerts', 'Visualizing dashboards'], correct: 2 },
                { question: 'What is Loki used for?', options: ['Log aggregation', 'Metrics storage', 'Tracing', 'Container scanning'], correct: 0 },
                { question: 'What does MTTR measure?', options: ['Maximum Throughput Rate', 'Mean Time To Replicate', 'Minimum Traffic Requirement', 'Mean Time To Recovery'], correct: 3 },
                ...
                { question: 'What is PromQL?', options: ['Prometheus Query Language', 'A database engine', 'A protocol buffer format', 'A provisioning tool'], correct: 0 },
                { question: 'What is high cardinality a problem for in Prometheus?', options: ['Alert routing', 'Log formatting', 'Dashboard rendering', 'Time-series database performance'], correct: 3 },
                { question: 'What are the Four Golden Signals from the Google SRE book?', options: ['CPU, Memory, Disk, Network', 'Rate, Errors, Duration, Load', 'Latency, Traffic, Errors, Saturation', 'Uptime, Throughput, Lag, Cost'], correct: 2 },
                { question: 'What happens when an error budget is exhausted?', options: ['The service is shut down', 'SLOs are automatically relaxed', 'Alerts are silenced', 'New feature work pauses until reliability improves'], correct: 3 },
                { question: 'What is Thanos primarily used for?', options: ['Long-term Prometheus metrics storage and global querying', 'Replacing Prometheus', 'Log aggregation', 'Distributed tracing'], correct: 0 }
            ],
            codebase: [
                {
    ...
    "panels": [
      ...
      },
      {
        ...
        },
        {
            ...
            quiz: [
                { question: 'What file format does Ansible use for playbooks?', options: ['JSON', 'XML', 'YAML', 'INI'], correct: 2 },
                ...
                { question: 'What is Ansible Vault used for?', options: ['Encrypting sensitive data', 'Storage', 'Container management', 'Load balancing'], correct: 0 },
                { question: 'How does Ansible connect to managed hosts by default?', options: ['HTTP', 'RDP', 'FTP', 'SSH'], correct: 3 },
                { question: 'What are Ansible facts?', options: ['Task results', 'Encrypted variables', 'Auto-collected host information', 'Role dependencies'], correct: 2 },
                ...
                { question: 'What is the purpose of the "when" keyword in a task?', options: ['Run task at a scheduled time', 'Loop over items', 'Define handlers', 'Conditionally run task based on an expression'], correct: 3 },
                { question: 'What does "become: yes" enable in Ansible?', options: ['Privilege escalation (sudo)', 'Debug mode', 'Fact gathering', 'Check mode'], correct: 0 },
                ...
                { question: 'What replaced Ansible "with_items" in modern versions?', options: ['foreach', 'iterate', 'loop', 'each'], correct: 2 },
                { question: 'What templating engine does Ansible use?', options: ['Mustache', 'Handlebars', 'Jinja2', 'ERB'], correct: 2 },
                { question: 'What is Ansible AWX?', options: ['A module for AWS', 'An inventory plugin', 'A vault tool', 'Open-source web UI for managing Ansible at scale'], correct: 3 },
                { question: 'What does the "rescue" block do in Ansible?', options: ['Runs when tasks in the block fail', 'Saves task results', 'Restores files from backup', 'Escalates privileges'], correct: 0 },
                { question: 'What does the "serial" keyword control in Ansible?', options: ['Playbook order', 'Task execution speed', 'Number of hosts managed at once for rolling updates', 'SSH timeout'], correct: 2 },
                { question: 'What does "delegate_to" do in Ansible?', options: ['Delegates RBAC roles', 'Assigns inventory groups', 'Delegates to AWX', 'Runs a task on a different host than the current one'], correct: 3 }
            ],
            codebase: [
                {
