    ...
    "appUrl": {
      ...
      "value": "[concat('https://', parameters('appName'), '.azurewebsites.net')]"
        ...
        },
        {
            ...
            quiz: [
                { question: 'What does "Shift Left" mean in DevSecOps?', options: ['Integrate security early', 'Move to cloud', 'Use left-aligned code', 'Deploy faster'], correct: 0 },
                { question: 'What is SAST?', options: ['Simple Auth Service', 'Server Authentication', 'System Admin Tool', 'Static Application Security Testing'], correct: 3 },
                ...
                { question: 'What is the OWASP Top 10?', options: ['Best frameworks', 'Programming languages', 'Critical web security risks', 'Cloud providers'], correct: 2 },
                ...
                { question: 'What does SBOM stand for?', options: ['Software Bill of Materials', 'Secure Build Output Map', 'System Binary Object Model', 'Security Baseline Operations Manual'], correct: 0 },
                { question: 'What is Policy as Code?', options: ['Writing documentation', 'Coding security patches', 'A compliance framework', 'Defining security policies in code for automation'], correct: 3 },
                { question: 'What does CSPM stand for?', options: ['Container Security Policy Manager', 'Continuous Security Pipeline Monitor', 'Cloud Security Posture Management', 'Code Scanning and Patch Management'], correct: 2 },
                ...
                { question: 'What is Falco used for?', options: ['Runtime security monitoring', 'IaC scanning', 'Container building', 'Secret rotation'], correct: 0 },
                { question: 'What does secrets rotation protect against?', options: ['Source code leaks', 'Network attacks', 'Dependency vulnerabilities', 'Impact of credential compromise'], correct: 3 },
                { question: 'What is IAST?', options: ['A firewall type', 'A cloud security scanner', 'Interactive Application Security Testing combining SAST and DAST', 'An IaC tool'], correct: 2 },
                ...
                { question: 'What is OWASP ZAP primarily used for?', options: ['Dynamic application security testing', 'Static code analysis', 'Container scanning', 'Secret rotation'], correct: 0 },
