    ...
    return (
      <div className="flex-1 flex items-center justify-center">
        <div className="text-center space-y-5 px-4">
          ...
          <div className="text-left space-y-2.5 text-xs text-slate-500 bg-slate-800/60 rounded-lg p-3 border border-slate-700/40">
            ...
            <p className="flex items-start gap-2.5">
              ...
              <span>Open a file from the <span className="text-slate-400">sidebar</span></span>
            </p>
            <p className="flex items-start gap-2.5">
              ...
              <span><span className="text-slate-400">Highlight code</span> to add it as context <span className="text-slate-600">(optional)</span></span>
            </p>
            <p className="flex items-start gap-2.5">
              ...
              <span>Click <span className="text-emerald-400 font-medium">Start Voice Session</span> and ask</span>
            </p>
          </div>
        </div>
      </div>
