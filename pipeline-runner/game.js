...
const QUESTIONS = {
    docker: [
        ...
        { q: "What is a Docker container?", a: ["A lightweight isolated environment", "A full VM with its own OS kernel", "A compiled application binary", "A type of hypervisor"], c: 0, fact: "Containers share the host OS kernel, making them much lighter than VMs." },
    ...
    aws: [
        ...
        { q: "What is AWS Lambda?", a: ["Serverless functions that run on-demand", "A managed container orchestration service", "An object storage service", "A dedicated VM instance type"], c: 0, fact: "Lambda scales automatically and charges per millisecond of execution time." },
        ...
        { q: "What is AWS CloudFormation?", a: ["Infrastructure as Code for AWS resources", "A managed monitoring and alerting service", "A CDN for distributing static content", "A container registry for Docker images"], c: 0, fact: "CloudFormation templates define AWS resources in YAML/JSON and manage them as a stack." },
    ...
    terraform: [
        ...
        { q: "What does 'terraform plan' show?", a: ["A preview of infrastructure changes before applying", "The current state of managed resources", "The list of configured providers", "The resolved values of input variables"], c: 0, fact: "Always run plan before apply — it shows exactly what will be created, changed, or destroyed." },
    ...
    git: [
        ...
        { q: "What is a Git branch?", a: ["Parallel version of code", "A copy of the remote repository", "A named snapshot saved with a tag", "A staging area for changes"], c: 0, fact: "Branches enable parallel development and feature isolation." },
    ...
    monitoring: [
        ...
        { q: "What is alerting in monitoring?", a: ["Notifications triggered when metrics cross thresholds", "The process of aggregating logs from multiple services", "Scraping and storing time-series metrics", "Visualizing data across multiple dashboards"], c: 0, fact: "Good alerts are actionable and avoid alert fatigue — each alert should require a human response." },
        ...
        { q: "What is distributed tracing?", a: ["Following a request's path across services", "Aggregating structured log events", "Recording CPU metrics over time", "Sampling and counting error rates"], c: 0, fact: "Distributed tracing follows requests across microservices." },
        { q: "What is observability?", a: ["Ability to understand system state from outputs", "The practice of collecting and storing logs", "A tool for visualizing metrics dashboards", "A framework for defining SLOs and SLIs"], c: 0, fact: "Observability is built on three pillars: metrics, logs, and traces." },
