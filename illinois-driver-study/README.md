...
- **Quiz Mode** - 59 official exam-style questions with instant feedback and explanations. Requires 80% to pass (matching Illinois DMV standard).
...
├── data/
│   └── questions.ts       # 59 questions in English and Vietnamese
├── services/
