...
const TRANSLATIONS = {
  en: {
    ...
    subtitle: "Practice with an AI instructor. The instructor will quiz you on the 59 official questions.",
    start: "Start Session",
    stop: "End Session",
