...
const TRANSLATIONS = {
  en: {
    ...
    subtitle: "Practice with an AI instructor. The instructor will quiz you on the 52 official questions.",
    start: "Start Session",
    stop: "End Session",
