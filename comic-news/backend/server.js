...
Conditions are expected to be worse to the south of the immediate Chicago area — with accumulating snow Saturday causing hazardous travel conditions, mostly south of Interstate 80.`,
  ...
  },
  {
    ...
    description: "Five years of lunches, baseball games, and a business friendship I genuinely valued. Then a Board of Trade function, one introduction, and thirty years of history I thought were long gone.",
    rating: 4.6,
    chapters: 1,
    status: "Completed",
    hasTextVersion: true,
...
I am in my early 50s. Single. Never married. I have no regrets about how I handled it.`,
  ...
  },
  {
    ...
    description: "An awkward moment at the checkout that spiraled into the most embarrassing exit of my life. Full volume. Clear as a bell. The cashier handled it with more grace than I deserved.",
    rating: 4.8,
    chapters: 1,
    status: "Completed",
    hasTextVersion: true,
...
I now wait for other people to laugh first. This is not cowardice. It is calibration.`,
    ...
    panels: [
      ...
      { id: 2, title: "The Highway", description: "No shoulder. Cars doing 70 mph. This was not going well for her." },
